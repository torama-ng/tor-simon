...
const handlebarsRoute = require('./routes/handlebar');
const react = require('./routes/react');
const bootsrap = require('./routes/bootsrap');
...
// app.use(cookieSession({ maxAge : 24 * 60 * 60 * 1000, keys : [projectKeys.session.sessionKeys]}));
...
app.use('/react' ,ensureAuthenticated , react);
app.use('/css' , ensureAuthenticated, css);
app.use('/angular', ensureAuthenticated, angular);
app.use('/bootstrap', ensureAuthenticated, bootsrap);
app.use('/handlebars',ensureAuthenticated, handlebarsRoute);

// Routes
app.use('/api/videos',ensureAuthenticated,videoRoutes);
app.use('/torplay',ensureAuthenticated,torplay);
